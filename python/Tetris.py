...
HEIGHT = 18			#all capital characters meaning constants(default)
WIDTH = 10
ACTIVE = 1
PASSIVE = 0
TRUE = 1
...
#BETTER: question in Space

class App(Frame):							#subclass of Frame
	def __init__(self, master):				#functions in class must have self as argument
		Frame.__init__(self)
	...
	def Play(self, event):
		showinfo('Made in China','^_</font></p>	<p><span mce_name="em" style="font-style: \
				italic;" class="Apple-style-span" mce_style="font-style: italic;"><span \
				style="font-size: small; " id="" mce_style="font-size: small;"><br></span>\
				</span></p> <p><span mce_name="em" style="font-style: italic;" \
				class="Apple-style-span" mce_style="font-style: italic;"><span \
				style="font-size: small; " id="" mce_style="font-size: small;">  </span>\
				</span></p> <p><br></p>') 
	...
	def Distroy(self):
		if self.TotalScore!=0: 
			savestr='%-9u%-8u%-8.2f%-14.2f%-13.2f%-14.2f%s/n' % (self.TotalScore, \
					self.TotalLine,self.TotalTime,self.TotalScore/self.TotalTime  \
				    ,self.TotalLine/self.TotalTime,float(self.TotalScore)/self.TotalLine \
