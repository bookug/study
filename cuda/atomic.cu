//Vector and Matrix computing: http://docs.nvidia.com/cuda/cublas/

//NOTICE: this file is not placed in cuda libs
#include "gputimer.h"
...
{   
//NOTICE: 3 types of copy
//cudaMemcpyHostToDevice cudaMemcpyDeviceToHost   cudaMemcpyDeviceToDevice
//Name: variable with h_* means host variable, variable with d_* means device variable
